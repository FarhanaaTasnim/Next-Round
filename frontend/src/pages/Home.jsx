  ...
  return (
    <Layout>
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-20 text-center">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-bold text-stone-800 dark:text-stone-100 leading-tight mb-5">
          Practice interviews that feel<br className="hidden sm:block" /> a little less scary.
        </h1>
        <p className="text-stone-500 dark:text-stone-400 text-lg max-w-xl mx-auto mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            to="/register"
            className="bg-rose-500 hover:bg-rose-600 text-white font-semibold px-7 py-3 rounded-full shadow-sm shadow-rose-200 dark:shadow-none transition"
          >
            Start practicing free
          </Link>
          <Link
            to="/login"
            className="text-stone-600 dark:text-stone-300 hover:text-rose-500 dark:hover:text-rose-400 font-medium px-7 py-3 rounded-full border border-stone-200 dark:border-stone-700 hover:border-rose-200 dark:hover:border-rose-400 transition"
          >
            I have an account
          </Link>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-20">
        <div className="grid sm:grid-cols-2 gap-5">
          {features.map((f) => (
            <div
              key={f.title}
              className="bg-white dark:bg-stone-900 rounded-3xl p-6 border border-rose-100 dark:border-stone-800 shadow-sm hover:shadow-md dark:shadow-none transition"
            >
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {companies.map((c) => (
            <span key={c} className="bg-white dark:bg-stone-900 border border-rose-100 dark:border-stone-800 text-stone-600 dark:text-stone-300 text-sm px-4 py-2 rounded-full">
              {c}
            </span>
          ))}
        </div>

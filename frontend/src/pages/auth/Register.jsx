      ...
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="font-display text-3xl font-bold text-stone-800 dark:text-stone-100">Create your account</h1>
            <p className="text-stone-500 dark:text-stone-400 mt-2">Start practicing in under a minute</p>
          </div>
